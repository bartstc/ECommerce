            ...
            if (!context.Products.Any())
            {
                var products = new List<ProductEntity>
                {
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(109.95m, Currency.USDollar.Code),
                        Rating = Rating.Of(3.9, 120),
                        ImageUrl = "https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_.jpg",
                        Category = Category.Clothing,
                        AddedAt = DateTime.Parse("2025-02-02T00:00:00Z").ToUniversalTime()
                    },
                    new ProductEntity
                    {
                        Name = "Mens Casual Premium Slim Fit T-Shirts",
                        Description = "Slim-fitting style, contrast raglan long sleeve, three-button henley placket, light weight & soft fabric for breathable and comfortable wearing. And Solid stitched shirts with round neck made for durability and a great fit for casual fashion wear and diehard baseball fans. The Henley style round neckline includes a three-button placket.",
                        Price = Money.Of(22.3m, Currency.USDollar.Code),
                        Rating = Rating.Of(4.1, 259),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(55.99m, Currency.USDollar.Code),
                        Rating = Rating.Of(4.7, 500),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(15.99m, Currency.USDollar.Code),
                        Rating = Rating.Of(2.1, 430),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(695m, Currency.USDollar.Code),
                        Rating = Rating.Of(4.6, 400),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(168m, Currency.USDollar.Code),
                        Rating = Rating.Of(3.9, 70),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(9.99m, Currency.USDollar.Code),
                        Rating = Rating.Of(3, 400),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(10.99m, Currency.USDollar.Code),
                        Rating = Rating.Of(1.9, 100),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(64m, Currency.USDollar.Code),
                        Rating = Rating.Of(3.3, 203),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(109m, Currency.USDollar.Code),
                        Rating = Rating.Of(2.9, 470),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(114m, Currency.USDollar.Code),
                        Rating = Rating.Of(4.8, 400),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(599m, Currency.USDollar.Code),
                        Rating = Rating.Of(2.9, 250),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(999.99m, Currency.USDollar.Code),
                        Rating = Rating.Of(2.2, 140),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(56.99m, Currency.USDollar.Code),
                        Rating = Rating.Of(2.6, 235),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(29.95m, Currency.USDollar.Code),
                        Rating = Rating.Of(2.9, 340),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(39.99m, Currency.USDollar.Code),
                        Rating = Rating.Of(3.8, 679),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(9.85m, Currency.USDollar.Code),
                        Rating = Rating.Of(4.7, 130),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(7.95m, Currency.USDollar.Code),
                        Rating = Rating.Of(4.5, 146),
                    ...
                    new ProductEntity
                    {
                        ...
                        Price = Money.Of(12.99m, Currency.USDollar.Code),
                        Rating = Rating.Of(3.6, 145),
